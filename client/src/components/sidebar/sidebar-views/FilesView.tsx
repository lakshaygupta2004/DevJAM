...
function FilesView() {
  ...
  return (
    <div
      className="flex select-none flex-col gap-1 px-4 py-2 bg-devjam-light text-devjam-text dark:bg-white dark:text-devjam transition-colors"
    ...
    >
      ...
      >
        <hr className="border-devjam-accent mb-2" />

        <button
          className="mt-2 flex w-full items-center justify-start gap-2 rounded-md bg-devjam-accent/10 px-3 py-2 text-sm font-medium hover:bg-devjam-hover transition disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        <button
          className="mt-2 flex w-full items-center justify-start gap-2 rounded-md bg-devjam-accent/10 px-3 py-2 text-sm font-medium hover:bg-devjam-hover transition"
