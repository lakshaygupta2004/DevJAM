...
function GitHubCorner() {
  ...
  return (
    <a
      ...
      className="w-[50px] h-[50px] text-center fixed top-1 right-4 z-40 bg-devjam rounded-full pt-3 transition-all duration-300 hover:scale-105"
    ...
    >
      ...
      >
        <path d="M0 0h250v250z" fill="transparent" />
        <path
